    ...
    <div class="p-8">
      <div :class="isDark ? 'text-gray-300' : 'text-gray-700'">
        ...
        <div
          ...
          :class="
            isDark
              ? 'bg-red-900/10 text-red-300 border-red-800/20'
        ...
        <div v-else>
          <ul class="space-y-6 mb-8">
            ...
            >
              <div
                class="p-3 rounded-xl mr-5 flex-shrink-0 mt-0.5"
        ...
        <!-- 提示信息 - 更宽敞 -->
        <div
          class="p-8 rounded-xl border border-dashed"
          :class="isDark ? 'border-gray-700 bg-gray-700/30' : 'border-gray-300 bg-gray-50'"
        >
          <div class="flex items-start">
            <div
              class="p-3 rounded-full mr-5 flex-shrink-0"
