<template>
  <div class="max-w-7xl mx-auto px-6">
    ...
    <div v-if="hasTargets" class="fixed bottom-6 right-6 flex flex-col space-y-3">
      <button @click="scrollToTop" class="p-3 rounded-full shadow-lg transition-all duration-200 hover:scale-110"
              :class="isDark ? 'bg-gray-800 text-gray-300 hover:bg-gray-700' : 'bg-white text-gray-700 hover:bg-gray-100'">
