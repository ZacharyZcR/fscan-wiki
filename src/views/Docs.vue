...
// 导入所有Markdown文档
const markdownDocs = import.meta.glob('../docs/*.md', { query: '?raw', import: 'default', eager: true })
...
[+] 192.168.1.4:8080 [CVE-2021-44228] Log4j RCE</code></pre>
  ...
  'scan-engine': {
    ...
    description: '扫描调度和流程控制',
    icon: 'mdi:engine',
    content: markdownDocs['../docs/scan-engine.md'],
  },
  'alive-detection': {
    title: '存活探测',
    description: '主机存活探测机制',
    icon: 'mdi:pulse',
    content: markdownDocs['../docs/alive-detection.md'],
  },
  'port-scan': {
    title: '端口扫描',
    description: '端口扫描策略和优化',
    icon: 'mdi:lan-connect',
    content: markdownDocs['../docs/port-scan.md'],
  },
  'service-identification': {
    title: '服务识别',
    description: '服务指纹识别系统',
    icon: 'mdi:application-cog',
    content: markdownDocs['../docs/service-identification.md'],
  },
  'web-scan': {
    title: 'Web 扫描',
    description: 'Web 应用扫描架构',
    icon: 'mdi:web',
    content: markdownDocs['../docs/web-scan.md'],
  },
  'local-scan': {
    title: '本地扫描',
    description: '本地权限和后渗透',
    icon: 'mdi:desktop-tower',
    content: markdownDocs['../docs/local-scan.md'],
  },
  'config-system': {
    title: '配置系统',
    description: '全局配置管理',
    icon: 'mdi:cog-outline',
    content: markdownDocs['../docs/config-system.md'],
  },
  'parser-system': {
    title: '解析系统',
    description: '输入解析和验证',
    icon: 'mdi:code-braces',
    content: markdownDocs['../docs/parser-system.md'],
  },
  'proxy-system': {
    title: '代理系统',
    description: '代理支持和流量转发',
    icon: 'mdi:swap-horizontal',
    content: markdownDocs['../docs/proxy-system.md'],
  },
  'i18n-system': {
    title: '国际化系统',
    description: '多语言支持',
    icon: 'mdi:translate',
    content: markdownDocs['../docs/i18n-system.md'],
  },
  'fingerprint-system': {
    title: '指纹识别',
    description: 'Web 和端口指纹识别',
    icon: 'mdi:fingerprint',
    content: markdownDocs['../docs/fingerprint-system.md'],
  },
  'poc-system': {
    title: 'POC 检测',
    description: 'POC 漏洞检测引擎',
    icon: 'mdi:bug-check',
    content: markdownDocs['../docs/poc-system.md'],
  },
  faq: {
    title: '常见问题',
    description: '常见问题解答',
    icon: 'mdi:help-circle',
    content: markdownDocs['../docs/faq.md'],
  },
}
