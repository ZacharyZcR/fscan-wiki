<template>
  ...
  >
    ...
    <div class="p-8">
      <!-- 标准认证参数 -->
      <div class="mb-10">
        <h3 class="text-xl font-medium mb-4" :class="isDark ? 'text-gray-300' : 'text-gray-700'">
          <Icon
            icon="mdi:account-key"
            class="mr-2 text-xl inline-block"
            :class="isDark ? 'text-blue-400' : 'text-blue-600'"
          />
          标准认证参数
        </h3>
      ...
      <div>
        <div class="flex items-center justify-between mb-4">
          <h3 class="text-xl font-medium" :class="isDark ? 'text-gray-300' : 'text-gray-700'">
            <Icon
              icon="mdi:database"
              class="mr-2 text-xl inline-block"
              :class="isDark ? 'text-blue-400' : 'text-blue-600'"
          ...
          <div class="flex items-center">
            ...
            <button class="flex-shrink-0" @click="toggleRedisDisable">
              <div
