<template>
  ...
  >
    ...
    <div class="mb-10 relative">
      ...
      <p
        class="mt-3 text-lg transition-colors duration-300 max-w-3xl"
    ...
    <div class="flex flex-col lg:flex-row gap-10">
      ...
      <div class="lg:w-80 order-2 lg:order-1">
        <div
          class="sticky top-24 transition-all duration-300 rounded-xl overflow-hidden shadow-lg border"
          :class="
            isDark
              ? 'bg-gray-800/90 backdrop-blur-sm border-gray-700/30'
              : 'bg-white border-gray-100'
          "
        >
          <div
            class="p-4 transition-colors duration-300 border-b flex items-center justify-between"
            :class="isDark ? 'border-gray-700/70' : 'border-gray-100'"
          >
            <h2
              class="text-lg font-bold transition-colors duration-300 flex items-center"
              :class="isDark ? 'text-white' : 'text-gray-900'"
            >
              <Icon
                icon="mdi:view-list"
          ...
          <div class="p-4 max-h-[calc(100vh-180px)] overflow-y-auto custom-scrollbar">
            <div v-for="section in docSections" :key="section.title" class="mb-6 last:mb-0">
              ...
              <ul class="space-y-1 pl-6">
                <li v-for="doc in section.docs" :key="doc.id">
                  ...
                  >
                    <span
                      class="w-1.5 h-1.5 rounded-full mr-2 transition-all duration-200"
                      :class="
                        activeDoc === doc.id
                          ? isDark
          ...
          <!-- 文档版本 - 增强底部设计 -->
          <div
            class="p-4 border-t transition-colors duration-300 flex items-center justify-between"
            :class="isDark ? 'border-gray-700/70' : 'border-gray-100'"
          >
            ...
            <a
              href="#"
              class="p-1.5 rounded-md transition-colors duration-200 group"
              :class="
                isDark
                  ? 'text-gray-400 hover:text-white hover:bg-gray-700'
                  : 'text-gray-500 hover:text-gray-900 hover:bg-gray-100'
      ...
      <div class="flex-1 order-1 lg:order-2">
        <div v-if="!activeDoc || activeDoc === 'index'">
          <!-- 快速入门卡片 - 提升至更突出位置 -->
          <div
            class="transition-all duration-300 rounded-xl overflow-hidden shadow-lg relative mb-10 border"
            :class="isDark ? 'bg-blue-900/20 border-blue-800/30' : 'bg-blue-50 border-blue-100'"
          >
            <div
              class="absolute top-0 right-0 w-40 h-40 transform translate-x-8 -translate-y-8 opacity-10"
            >
              <Icon
            ...
            <div class="p-6">
              <div class="flex items-center mb-4">
                <div
                  class="w-12 h-12 rounded-xl flex items-center justify-center bg-blue-100 dark:bg-blue-900/30 shadow-sm"
                >
                  <Icon
                    icon="mdi:rocket-launch"
                ...
                <h2
                  class="text-2xl font-bold ml-4 transition-colors duration-300"
              ...
              <p
                class="mb-5 transition-colors duration-300 relative max-w-2xl text-lg"
              ...
              <div
                class="bg-gray-900 text-gray-200 p-4 rounded-lg overflow-x-auto mb-5 relative shadow-inner"
              >
                ...
                <pre
                  class="text-sm font-mono pt-2"
                ><code>./fscan -h 192.168.1.1/24 -p 22,80,3306,6379,9200 -o result.txt</code></pre>
              </div>

              <router-link
                to="/documents/quick-start"
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
            <div
              ...
              :class="
                isDark
                  ? 'bg-gray-800 hover:shadow-blue-900/20 border-gray-700/30'
            ...
            >
              <div class="p-6">
                <div class="flex items-center mb-5">
                  ...
                  <h2
                    class="text-xl font-bold ml-4 transition-colors duration-300"
                    :class="isDark ? 'text-white' : 'text-gray-900'"
                  >
                    {{ section.title }}
                  </h2>
                ...
                <ul class="space-y-2.5 pl-1">
                  <li v-for="doc in section.docs" :key="doc.id">
                    ...
                    >
                      <span
                        class="w-1.5 h-1.5 rounded-full mr-2 flex-shrink-0 transition-all duration-200"
                        :class="
                          isDark
                      ...
                      <Icon
                        ...
                        class="ml-auto text-lg transition-transform duration-200 opacity-0 group-hover:opacity-100 group-hover:translate-x-1"
          ...
          <!-- 热门文档 - 设计升级 -->
          <div
            class="transition-colors duration-300 rounded-xl overflow-hidden shadow-lg border"
            ...
            <div class="p-6">
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <router-link
                  ...
                  :class="
                    isDark
                      ? 'hover:bg-gray-700 text-gray-300 border-gray-700 hover:border-gray-600'
                      : 'hover:bg-gray-50 text-gray-700 border-gray-100 hover:border-gray-200'
                  "
                >
                  <div
                    class="w-10 h-10 rounded-lg flex items-center justify-center mr-4 transition-transform duration-200 group-hover:scale-110"
                    :class="doc.bgColor"
                  >
                  ...
                  <div>
                    <div
                      ...
                      :class="isDark ? 'group-hover:text-white' : 'group-hover:text-gray-900'"
                    >
                      {{ doc.title }}
                    </div>
        ...
        <div v-else>
          ...
          <!-- 文档内容容器 - 更舒适的阅读空间 -->
          <div
            class="transition-colors duration-300 rounded-xl overflow-hidden shadow-lg p-8 mb-8 border"
            :class="isDark ? 'bg-gray-800 border-gray-700/30' : 'bg-white border-gray-100'"
          >
          ...
          <div class="flex justify-between items-center">
            <router-link
              v-if="prevDoc"
              :to="`/documents/${prevDoc.id}`"
              class="inline-flex items-center px-4 py-2 rounded-lg transition-all duration-200 border group"
              :class="
                isDark
                  ? 'text-gray-300 hover:bg-gray-800 hover:text-white border-gray-700 hover:border-gray-600'
  ...
  if (activeDoc.value && activeDoc.value !== 'index') {
    ...
    return markRaw(
      defineAsyncComponent({
        loader: () =>
          import(`../docs/${activeDoc.value}.vue`).catch(() => import('../docs/NotFound.vue')),
